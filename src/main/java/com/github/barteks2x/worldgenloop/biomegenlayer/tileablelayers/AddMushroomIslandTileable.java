...
public class AddMushroomIslandTileable extends GenLayerAddMushroomIsland implements TileableGenLayer {

	private int size;

	public AddMushroomIslandTileable(GenLayerAddMushroomIsland originalLayer) {
		super(0, null);
